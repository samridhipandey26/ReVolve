...
export default function Header({ onResetSession, isResetting }) {
  return (
            ...
            <div>
              <div className="flex items-center space-x-2.5">
                <h1 className="text-xl sm:text-2xl font-black tracking-tight text-white">
                  S15 — Intelligent Waste-Recovery Platform
                </h1>
              ...
              <p className="text-xs sm:text-sm text-slate-400 font-medium">
                One triage engine. Two waste streams. Five pathways.
              </p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-3 text-xs">
            {onResetSession && (
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-400 hover:text-slate-200 transition text-[11px] font-medium flex items-center space-x-1.5 disabled:opacity-50"
            ...
            <div className="px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 font-mono">
              v1.0.0
            </div>
          </div>
        </div>
